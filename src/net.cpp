...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Makicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Seed New York", "newyork.makicoin.com"},
    {"Seed San Francisco", "sanfrancisco.makicoin.com"},
    {"Seed Amsterdam", "amsterdam.makicoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"Makiseedtest", "makiseedtest.mnode.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Makicoin is probably already running."), addrBind.ToString().c_str());
        else
